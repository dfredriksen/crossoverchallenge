  ...
  renderClips() {
    ...
    for (index = 0; index < this.state.clips.length; index++) {
      ...
      clips.push(React.createElement(
        'li',
        null,
        React.createElement(VideoClip, _extends({}, clipData, { playEventPrefix: this.props.playEventPrefix, editEventPrefix: this.props.editEventPrefix, removeEventPrefix: this.props.removeEventPrefix, allowEdit: this.props.allowEdit, allowRemove: this.props.allowRemove, maxDuration: this.props.maxDuration })),
