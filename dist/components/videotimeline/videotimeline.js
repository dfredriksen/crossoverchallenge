...
class VideoTimeline extends React.Component {
  ...
  renderMarkers() {
    ...
    for (index = 0; index < clips.length; index++) {
      ...
      markers.push(React.createElement('span', { alt: clips[index].clipName, className: 'glyphicon glyphicon-map-marker', style: markerStyle, onClick: this.navigateMarker.bind(this, index) }));
    }
  ...
  renderComponents() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'progress-bar', role: 'progressbar', ariaValuenow: this.state.currentTime, ariaValuemin: '0', ariaValuemax: '100', style: progressStyle },
